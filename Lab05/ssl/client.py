...
context.check_hostname = False  # Không kiểm tra hostname (nếu dùng chứng chỉ tự ký)
context.verify_mode = ssl.CERT_NONE  # Không xác minh chứng chỉ (chỉ dùng khi test)
